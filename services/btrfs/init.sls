#
#   services/btrfs/init.sls
#   make sure all presented SSDs are in one btrfs on /data
#

{% grains['btrfs_targets'] = [] %}

# Create Disk Partitions and monitoring
...
{%- grains.append('btrfs_targets', ssd) %}
